...
En la escuela te dijeron que ese punto no ocupa espacio, no tiene cuerpo y es invisible… pero tú lo ves, lo pintas, y está ahí, en la pizarra. 
...
Cuando desplazas esa geometría idealizada hacia la física, aparece el desfase: necesitas la raíz de dos ($\sqrt{2}$) como factor de conversión para que el plano pueda interactuar con el volumen. 
...
Como la recta clásica no sabe traducirse al cuerpo sin perder información —al ignorar el cierre operativo de PI y el factor de conversión de $\sqrt{2}$— el modelo no puede registrar toda la energía que el metal realmente soporta. 
...
El Corpus Ignaciano propone un cimiento nuevo: PI como unidad cerrada, $\sqrt{2}$ como puente universal, continuidad sin fugas. Un sistema donde la existencia no se aproxima: se conserva.
